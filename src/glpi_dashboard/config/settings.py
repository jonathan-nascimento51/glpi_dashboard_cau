...
GLPI_USER_TOKEN = os.getenv("GLPI_USER_TOKEN", None)  # Optional, if using user token auth
...
REDIS_TTL_SECONDS = int(os.getenv("REDIS_TTL_SECONDS", "3600"))  # 1 hour TTL for raw JSON

# Pipeline Configuration
FETCH_PAGE_SIZE = int(os.getenv("FETCH_PAGE_SIZE", "50"))  # Default GLPI range is 0-50
