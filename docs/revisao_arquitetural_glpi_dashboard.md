...
Inicialização dos Contentores: As linhas [+] Correndo 5/5 e os subsequentes estados em execução e recriado para os contentores redis-1, postgres-1, initdb-1, dash-1 e worker-1 indicam que o ambiente Docker foi iniciado com sucesso. A mensagem initdb-1 | ✔ Banco de dados inicializado confirma que a base de dados subjacente foi preparada corretamente.
