...
| Mensagem "Arquivo JSON nao encontrado" | Caminho `KNOWLEDGE_BASE_FILE` incorreto | Confirme a existencia do arquivo com `ls -l` | "Ajuste `KNOWLEDGE_BASE_FILE` e gere dados com `python scripts/gen_mock_data.py`" |
