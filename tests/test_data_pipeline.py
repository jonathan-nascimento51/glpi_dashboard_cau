...
sample = [
    {"id": 1, "status": "new", "group": "N1", "date_creation": "2024-01-01", "assigned_to": "alice", "name": "t1"},
    {"id": 2, "status": "closed", "group": "N2", "date_creation": "2024-01-02", "assigned_to": "bob", "name": "t2"},
]


def test_process_list():
    df = process_raw(sample)
    assert list(df.columns[:5]) == ["id", "status", "group", "date_creation", "assigned_to"]
