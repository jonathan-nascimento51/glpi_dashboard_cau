...
=======
# Save images referenced in a compose file into a single tarball.
# Usage: ./save_docker_images.sh [output.tar] [--file compose.yml]
>>>>>>> theirs
set -euo pipefail
...
<<<<<<< ours
      usage
=======
      echo "Usage: $0 [output.tar] [--file compose.yml]" >&2
      exit 0
>>>>>>> theirs
      ;;
    *)
