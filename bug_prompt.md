...
.                                                                        [100%]
=============================== warnings summary ===============================
../../root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/flask_caching/__init__.py:145
tests/test_dash_offline.py::test_load_data_mock
tests/test_dash_offline.py::test_load_data_mock
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/flask_caching/__init__.py:145: DeprecationWarning: Using the initialization functions in flask_caching.backend is deprecated.  Use the a full path to backend classes directly.
    self._set_cache(app, config)

tests/test_database_async.py::test_insert_tickets_sqlite
tests/test_database_async.py::test_insert_tickets_sqlite
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/aiosqlite/core.py:105: DeprecationWarning:
...
tests/test_error_logger.py::test_extract_metadata_with_stack
tests/test_error_logger.py::test_extract_metadata_without_stack
tests/test_error_logger.py::test_main_cli
  /workspace/glpi_dashboard_cau/scripts/error_logger.py:37: DeprecationWarning:
  
  datetime.datetime.utcnow() is deprecated and scheduled for removal in a future version. Use timezone-aware objects to represent datetimes in UTC: datetime.datetime.now(datetime.UTC).

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /workspace/glpi_dashboard_cau/tests/test_pact_ticket_contract.py:36: PendingDeprecationWarning:
  
  This class will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /workspace/glpi_dashboard_cau/tests/test_pact_ticket_contract.py:37: PendingDeprecationWarning:
  
  This class will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/consumer.py:149: PendingDeprecationWarning:
  
  This class will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:134: PendingDeprecationWarning:
  
  This class will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:420: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:421: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:422: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:423: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:456: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py: 14 warnings
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/matchers.py:221: PendingDeprecationWarning:
  
  This function will be deprecated Pact Python v3 (see pact-foundation/pact-python#396)

tests/test_pact_ticket_contract.py::test_get_ticket_contract
  /root/.pyenv/versions/3.12.10/lib/python3.12/site-packages/pact/pact.py:457: PendingDeprecationWarning:
...
main.py                                                          66     36    45%   49-59, 66-67, 73-74, 87-92, 97-109, 114-122, 126-131
prompt_tester_langgraph.py                                       53     53     0%   1-86
src/__init__.py                                                   0      0   100%
src/api/__init__.py                                               0      0   100%
src/app/__init__.py                                               0      0   100%
src/app/application/__init__.py                                   0      0   100%
src/app/application/commands/__init__.py                          0      0   100%
src/app/application/commands/create_order_command.py              9      9     0%   1-12
src/app/application/commands/create_order_handler.py             10     10     0%   1-13
src/app/application/commands/user_service.py                     24      1    96%   32
src/app/application/queries/__init__.py                           0      0   100%
src/app/application/queries/get_order_by_id_handler.py            9      9     0%   1-13
src/app/application/queries/get_order_by_id_query.py              5      5     0%   1-7
src/app/domain/__init__.py                                        0      0   100%
src/app/domain/entities/__init__.py                               0      0   100%
src/app/domain/entities/order.py                                 18      1    94%   20
src/app/domain/entities/user.py                                   8      0   100%
src/app/domain/repositories/__init__.py                           0      0   100%
src/app/domain/repositories/order_repository.py                  10      0   100%
src/app/domain/repositories/user_repository.py                    9      0   100%
src/app/domain/value_objects/__init__.py                          0      0   100%
src/app/domain/value_objects/money.py                            17      2    88%   20, 24
src/app/infrastructure/__init__.py                                0      0   100%
src/app/infrastructure/persistence/__init__.py                    0      0   100%
src/app/infrastructure/persistence/sqlalchemy_repository.py      33      4    88%   43, 49-51
src/app/setup/__init__.py                                         0      0   100%
src/app/setup/ioc/__init__.py                                     0      0   100%
src/app/setup/ioc/container.py                                   15     15     0%   1-25
src/etl/__init__.py                                               0      0   100%
src/etl/tickets_groups.py                                       102     26    75%   42-49, 64, 68, 91, 112, 114, 128, 140-152, 170, 177-178, 184-187, 192-194
src/glpi_dashboard/__init__.py                                   19     11    42%   16-30
src/glpi_dashboard/cache.py                                       6      6     0%   3-18
src/glpi_dashboard/cli/__init__.py                                0      0   100%
src/glpi_dashboard/cli/tickets_groups.py                         16      4    75%   22-26
src/glpi_dashboard/config/__init__.py                             0      0   100%
src/glpi_dashboard/config/settings.py                            64      0   100%
src/glpi_dashboard/dashboard/__init__.py                          0      0   100%
src/glpi_dashboard/dashboard/callbacks.py                        22     16    27%   11-13, 19-51
src/glpi_dashboard/dashboard/components.py                       15      0   100%
src/glpi_dashboard/dashboard/layout.py                           12      4    67%   10-13, 54
src/glpi_dashboard/data/__init__.py                               0      0   100%
src/glpi_dashboard/data/database.py                             104     35    66%   41, 59-87, 96, 116-120, 134-135, 156-163, 192-197
src/glpi_dashboard/data/pipeline.py                              37      2    95%   34, 99
src/glpi_dashboard/data/tickets_groups.py                        11      0   100%
src/glpi_dashboard/data/transform.py                             22      2    91%   35, 42
src/glpi_dashboard/glpi_adapter.py                               83     16    81%   70-72, 96-98, 117, 120-122, 142-143, 147-151
src/glpi_dashboard/glpi_client.py                                64     28    56%   69, 74-99, 105-106
src/glpi_dashboard/logging_config.py                             21      1    95%   43
src/glpi_dashboard/providers.py                                  39     39     0%   1-63
src/glpi_dashboard/services/__init__.py                           8      0   100%
src/glpi_dashboard/services/aggregated_metrics.py                22      1    95%   16
src/glpi_dashboard/services/batch_fetch.py                       37      8    78%   55-61, 77
src/glpi_dashboard/services/exceptions.py                        81      4    95%   108-110, 216
src/glpi_dashboard/services/glpi_api_client.py                  143     32    78%   82, 91-102, 107, 128-133, 139-140, 151, 218, 223, 226-227, 256, 277-283, 288-290, 306-312
src/glpi_dashboard/services/glpi_rest_client.py                 112     28    75%   130, 140-155, 175, 204, 215, 217, 225, 258, 260, 273, 275, 312, 314, 318-319, 332-348
src/glpi_dashboard/services/glpi_session.py                     221     40    82%   135, 168, 175, 191-193, 219, 228-231, 243-244, 257-258, 294, 311, 321-322, 372, 378, 435-438, 512-531, 545
src/glpi_dashboard/services/graphql_client.py                    29      4    86%   74-83
src/glpi_dashboard/services/langgraph_workflow.py               117      2    98%   170, 242
src/glpi_dashboard/services/tool_error.py                         7      0   100%
src/glpi_dashboard/services/worker_api.py                       188     14    93%   91-92, 99-106, 110, 117, 121-122, 130-134
src/glpi_dashboard/telemetry.py                                  45      1    98%   27
src/glpi_dashboard/ticket_status.py                              47      0   100%
src/glpi_dashboard/utils/__init__.py                              4      0   100%
src/glpi_dashboard/utils/dataframe.py                             8      1    88%   13
src/glpi_dashboard/utils/messages.py                              6      0   100%
src/glpi_dashboard/utils/redis_client.py                        100     31    69%   55-69, 91-101, 113-117, 132-133, 149-151
src/main.py                                                      14     14     0%   1-21
-------------------------------------------------------------------------------------------
TOTAL                                                          2112    515    76%
Required test coverage of 70% reached. Total coverage: 75.62%
141 passed, 3 skipped, 1 deselected, 2 xfailed, 32 warnings in 14.25s
...
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.base_url' imported but unused
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.app_token' imported but unused
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.username' imported but unused
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.password' imported but unused
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.mock_client_session' imported but unused
./tests/conftest.py:2:1: F401 'tests.test_glpi_session.mock_response' imported but unused
./tests/conftest.py:13:22: F811 redefinition of unused 'base_url' from line 2
./tests/conftest.py:18:23: F811 redefinition of unused 'app_token' from line 2
./tests/conftest.py:23:22: F811 redefinition of unused 'username' from line 2
./tests/conftest.py:28:22: F811 redefinition of unused 'password' from line 2
./tests/conftest.py:33:33: F811 redefinition of unused 'mock_client_session' from line 2
./tests/conftest.py:38:27: F811 redefinition of unused 'mock_response' from line 2
./tests/e2e/test_flow.py:8:1: E402 module level import not at top of file
./tests/integration/test_dashboard.py:22:89: E501 line too long (90 > 88 characters)
./tests/test_aggregated_metrics.py:4:1: E402 module level import not at top of file
./tests/test_aggregated_metrics.py:6:1: E402 module level import not at top of file
./tests/test_aggregated_metrics.py:7:1: E402 module level import not at top of file
./tests/test_aggregated_metrics.py:13:1: E402 module level import not at top of file
./tests/test_aggregated_metrics.py:14:1: E402 module level import not at top of file
./tests/test_dashboard_components.py:4:1: E402 module level import not at top of file
./tests/test_dashboard_components.py:6:1: E402 module level import not at top of file
./tests/test_dashboard_components.py:7:1: E402 module level import not at top of file
./tests/test_dashboard_components.py:9:1: E402 module level import not at top of file
./tests/test_dashboard_layout.py:23:1: E402 module level import not at top of file
...
./tests/test_glpi_refresh_retry.py:9:1: F401 'tests.test_glpi_session.mock_client_session as _mock_client_session' imported but unused
./tests/test_glpi_refresh_retry.py:10:1: F401 'tests.test_glpi_session.base_url as _base_url' imported but unused
./tests/test_glpi_refresh_retry.py:11:1: F401 'tests.test_glpi_session.app_token as _app_token' imported but unused
./tests/test_glpi_refresh_retry.py:12:1: F401 'tests.test_glpi_session.username as _username' imported but unused
./tests/test_glpi_refresh_retry.py:13:1: F401 'tests.test_glpi_session.password as _password' imported but unused
./tests/test_glpi_refresh_retry.py:19:5: F811 redefinition of unused '_base_url' from line 10
./tests/test_glpi_refresh_retry.py:19:16: F811 redefinition of unused '_app_token' from line 11
./tests/test_glpi_refresh_retry.py:19:28: F811 redefinition of unused '_username' from line 12
./tests/test_glpi_refresh_retry.py:19:39: F811 redefinition of unused '_password' from line 13
./tests/test_glpi_refresh_retry.py:19:50: F811 redefinition of unused '_mock_client_session' from line 9
./tests/test_glpi_refresh_retry.py:48:5: F811 redefinition of unused '_base_url' from line 10
./tests/test_glpi_refresh_retry.py:48:16: F811 redefinition of unused '_app_token' from line 11
./tests/test_glpi_refresh_retry.py:48:28: F811 redefinition of unused '_username' from line 12
./tests/test_glpi_refresh_retry.py:48:39: F811 redefinition of unused '_password' from line 13
./tests/test_glpi_refresh_retry.py:48:50: F811 redefinition of unused '_mock_client_session' from line 9
./tests/test_glpi_refresh_retry.py:59:89: E501 line too long (115 > 88 characters)
...
./tests/test_telemetry.py:4:89: E501 line too long (97 > 88 characters)
./tests/test_telemetry.py:7:1: E402 module level import not at top of file
...
### merge_conflicts
```
bug_prompt.md: conflict markers at lines 13, 89
...
.venv/lib/python3.12/site-packages/pybreaker-1.3.0.dist-info/METADATA: conflict markers at lines 28
